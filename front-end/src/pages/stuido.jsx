...
const Stuido = () => {
    return (
        <AuthLayout bg={'bg-yellowejp'} menu1={'Our Facility'} menu2={'Jadwal Booking'} menu3={'Unit Binsis'} menuActive={'bg-yellowejp text-ejp'} bgColor={'bg-ejp'} hover={'hover:bg-yellowejp hover:text-ejp p-3 rounded-lg'}>
