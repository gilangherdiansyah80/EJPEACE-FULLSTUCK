        ...
        <section className="flex flex-col gap-y-10">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-3 flex flex-col gap-y-3 lg:grid-cols-3">
                {paginatedProgram.map((item) => (
                    <Card 
                        key={item.id} 
                        style={`w-full bg-[#FFC255] text-black shadow-2xl rounded-lg flex flex-col gap-3 p-3 transition-all duration-300 
                        ...
                        bgImage={'bg-black opacity-10'}
                    >
                        <button className="bg-[#FB7316] rounded-lg justify-center text-black p-2 flex gap-3 font-swiss w-full">
                            Kunjungi
                            <span>
...
export default ProgramHighlightSquad;
