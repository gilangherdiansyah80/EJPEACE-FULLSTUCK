const ContactAcademy = () => {
    return (
        <section className="shadow-xl mt-24">
                    ...
                    <div className="bg-[#FBA9DB] rounded-b-lg flex flex-col gap-y-3 p-3 md:flex-row md:justify-center md:gap-x-5 ">
                        <div className="bg-white flex justify-center items-center rounded-lg p-3 md:w-[400px] md:h-[441px]">
                            <div className="gap-y-3 flex flex-col lg:justify-evenly items-center lg:h-80">
                                <div className="flex flex-col gap-y-3 justify-center items-center">
                                    <i className="fas fa-home text-6xl text-[#DE4FC1]"></i>
                                    <h1 className="lg:text-3xl font-bold text-[#DE4FC1]">Alamat</h1>
                                </div>
                                <p className="text-center">Jl. Sritunggal No.4, Cigereleng, Kec. Regol, Kota Bandung, Jawa Barat 40253</p>
                                <button className="bg-[#DE4FC1] p-2 rounded-md">Kunjungi</button>
                            </div>
                        </div>
                        <div className="bg-white flex justify-center items-center rounded-lg p-3 gap-y-3 md:w-[400px] md:h-[441px]">
                            <div className="gap-y-3 flex flex-col lg:gap-y-20 lg:justify-around items-center lg:h-80">
                                <div className="flex flex-col gap-y-3 justify-center items-center">
                                    <i className="fab fa-whatsapp text-6xl text-[#DE4FC1]"></i>
                                    <h1 className="lg:text-3xl font-bold text-[#DE4FC1]">Whatsapp</h1>
                                </div>
                                <button className="bg-[#DE4FC1] rounded-md p-2">Hubungi</button>
                            </div>
                        </div>
                        <div className="bg-white flex justify-center items-center rounded-lg p-3 gap-y-3 md:w-[400px] md:h-[441px]">
                            <div className="gap-y-3 flex flex-col lg:gap-y-20 lg:justify-around items-center lg:h-80">
                                <div className="flex flex-col gap-y-3 justify-center items-center">
                                    <i className="far fa-envelope text-6xl text-[#DE4FC1]"></i>
                                    <h1 className="lg:text-3xl font-bold text-[#DE4FC1]">Email</h1>
                                </div>
                                <button className="bg-[#DE4FC1] rounded-md p-2">Hubungi</button>
                            </div>
                        </div>
